...
SUBROUTINE hinit0()
  ...
  !
  call sirius_start_timer(string("qe|init_run|hinit0|init_vloc"))
  CALL init_vloc()
  call sirius_stop_timer(string("qe|init_run|hinit0|init_vloc"))
  !
  ...
  !
  call sirius_start_timer(string("qe|init_run|hinit0|struc_fact"))
  CALL struc_fact( nat, tau, nsp, ityp, ngm, g, bg, &
                   dfftp%nr1, dfftp%nr2, dfftp%nr3, strf, eigts1, eigts2, eigts3 )
  call sirius_stop_timer(string("qe|init_run|hinit0|struc_fact"))
  !
  ...
  !
  call sirius_start_timer(string("qe|init_run|hinit0|set_local"))
  CALL setlocal()
  call sirius_stop_timer(string("qe|init_run|hinit0|set_local"))
  !
  ! ... calculate the core charge (if any) for the nonlinear core correction
  !
  call sirius_start_timer(string("qe|init_run|hinit0|set_rhoc"))
  CALL set_rhoc()
  call sirius_stop_timer(string("qe|init_run|hinit0|set_rhoc"))
  !
