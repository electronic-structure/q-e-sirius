...
!
!---------------------------------------------------------------------
SUBROUTINE crpa_symdvscf (dvtosym)
  !---------------------------------------------------------------------
  !
  ...
  !
  call start_clock ('crpa_symdvscf')
  !
...
!   ENDDO
  ...
  deallocate (dvsym)
  !
  call stop_clock ('crpa_symdvscf')
  !
  RETURN
  !
END SUBROUTINE crpa_symdvscf
