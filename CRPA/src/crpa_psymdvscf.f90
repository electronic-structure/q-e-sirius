...
!
!-----------------------------------------------------------------------
SUBROUTINE crpa_psymdvscf (dvtosym)
  !-----------------------------------------------------------------------
  !
  ...
  !
  CALL start_clock ('crpa_psymdvscf')
  !
  ...
  DEALLOCATE (ddvtosym)
  !
  CALL stop_clock ('crpa_psymdvscf')
  !
#else
  !
  CALL crpa_symdvscf (dvtosym)
  !
#endif
  !
  RETURN
  !
END SUBROUTINE crpa_psymdvscf
