...
SUBROUTINE crpa_setup_q()
  ...
  USE eqv,              ONLY : dmuxc
  USE qpoint,           ONLY : xq
  USE control_lr,       ONLY : lgamma, flmixdpot, reduce_io, niter_ph, alpha_mix
  ...
  !
  CALL stop_clock ('crpa_setup_q')
  !
  RETURN
  !
END SUBROUTINE crpa_setup_q
