...
!
!-----------------------------------------------------------------------
SUBROUTINE crpa_psym_dmag (dvtosym)
    !-----------------------------------------------------------------------
    !
    ...
    CALL start_clock ('crpa_psym_dmag')
    ...
    CALL stop_clock ('crpa_psym_dmag')
#else
    CALL crpa_sym_dmag (dvtosym)
#endif

    RETURN

  END SUBROUTINE crpa_psym_dmag
