...
CONTAINS
  ...
  SUBROUTINE system_defaults( prog )
    ...
    SUBROUTINE wannier_ac_defaults( prog )
      ...
      RETURN
      !
    END SUBROUTINE wannier_ac_defaults
    ...
    SUBROUTINE press_ai_defaults( prog )
      ...
      RETURN
      !
    END SUBROUTINE press_ai_defaults
    !
    !=----------------------------------------------------------------------=!
    !
    ...
    SUBROUTINE wannier_defaults( prog )
      ...
      RETURN
      !
    END SUBROUTINE wannier_defaults
    !
    !=----------------------------------------------------------------------=!
    !
    ...
    SUBROUTINE wannier_ac_bcast()
      ...
      RETURN
      !
    END SUBROUTINE wannier_ac_bcast
    ...
    SUBROUTINE wannier_checkin( prog )
      ...
      RETURN
      !
    END SUBROUTINE wannier_checkin
    !
    !=----------------------------------------------------------------------=!
    !
    ...
    SUBROUTINE wannier_ac_checkin( prog )
      ...
      RETURN
      !
    END SUBROUTINE wannier_ac_checkin
    !
    !=----------------------------------------------------------------------=!
    !
